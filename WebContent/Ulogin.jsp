...
<!-- header -->
	...
	<div class="product_list_header">  
			<form action="AddtoCart2 " method="post">
                 ...
                 <fieldset>
                 <% System.out.println(" value to ulogin .jsp ==============="); %>
...
<h2 style="color:red;margin-left:200px"><%if(name=="value"){ %>
			...
			<div class="w3_login_module">
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="Userlogin_process" method="post">
				  ...
				  <div class="form">
					...
					<form action="RegistrationProcess" method="post">
					  ...
					  <input type="password" name="pnumber" placeholder="Phone No" required=" ">
