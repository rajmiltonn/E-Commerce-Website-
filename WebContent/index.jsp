...
<!-- header -->
	<div class="agileits_header">
		<div class="w3l_offers">
			<a href="#l">Today's special Offers !</a>
		</div>
		<div class="w3l_search" style="z-index:100">
			<form name="vinform">
				<input type="text" name="name" placeholder="Search a product..." onkeyup="searchInfo()">
			</form>
		...
		<div class="product_list_header"> 
		 ...
		 <fieldset>
       <a href="AddtoCart2" >  <input type="submit" name="submit" value="View your cart" class="button" /></a>
				...
				<li class="dropdown profile_details_drop">
					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							...
							String name12 =(String) session1.getAttribute("email");
							if(name1!=null)
							{ %>
							<li><%=name1 %></li>
							...
							else
							{
								if(name12!=null){
									%>
									<li><a href="DisplayProduct.jsp">Admin Panel</a></li> 
									<%
								}
								else{
								%>
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:kuet.ac.bd">store@buyme.com</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
					...
					<ul class="slides">
						<li>
							<div class="w3l_banner_nav_right_banner">
								...
								<div class="more">
									<a href="#l" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
								</div>
							</div>
						</li>
						<li>
...
<!-- top-brands -->
	<div class="top-brands">
		<div class="container">
			<h3>Currently Available Items</h3>
        ...
        while(rs.next()){
         ...
         %> 
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <a class="lightbox" href="showImage.jsp?Id=<%= rs.getInt(1) %> ">
                        <img src='<%=rs.getString(11)%>' alt="Park" style="width:300px;height:250px;" />
                        
                    </a>
                    <div class="caption">
                        <center> <h4> US $<%=rs.getString(7)%></h4></center>
                        <p><%=rs.getString(8)%>.</p>
               <center> 
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               <table>
               <tr><td> 
              <a class="lightbox" href="AddtoCart_Process?Id=<%= rs.getInt(1) %>">Add to Cart  </a>
              ...
              &nbsp; &nbsp; &nbsp;
                 ...
                 <a href="BuyProduct.jsp?Id1=<%=rs.getInt(1) %>&Id=<%=rs.getInt(7) %>"> Buy </a>
				...
				<div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_left">
					<div class="w3l_fresh_vegetables_grid2">
						<ul>
							...
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="#l">Dry Fruits</a></li>
