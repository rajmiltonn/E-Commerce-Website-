...
<%@include file="sidebar.jsp" %>				
			...
			<form class="form-horizontal row-fluid" action="Insert_process" method="post" >
...
<div class="controls">
<input type="file" class="span8 tip"onchange="convertToStringAndShow(this);" required  />
<img src="" id="imageTag"/>
<input type="hidden" name="productimage1" id="strImage" />         
</div>
</div>
