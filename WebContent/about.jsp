...
<!-- header -->
	<div class="agileits_header">
				...
				<li class="dropdown profile_details_drop">
					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							...
							{ %>
							<li><%=name1 %></li>
								<li><a href="Logout_process">Logout</a></li><% 
							...
							else
							{
								...
								<li><a href="Ulogin.jsp">User Sign Up</a></li>
		...
		<div class="w3l_header_right1">
			<h2><a href="about.jsp">Contact Us</a></h2>
		</div>
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:store@grocery.com">store@buyme.com</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
					...
					<ul class="nav navbar-nav nav_1">
						...
						<li class="dropdown">
							...
							<div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
								<div class="w3ls_vegetables">
									<ul>
										<li><a href="#l">Frozen Snacks</a></li>
		...
		<div class="container">
			...
			<div class="agileits_team_grids">
				<div class="col-md-3 agileits_team_grid">
					<img src="images/mypic.jpg" alt=" " class="img-responsive" style="width:250px;height:250px;" />
					<h4>Developer</h4>
					<h4>Md Safiullah</h4>
					<br>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="images/100.jpg" alt=" " class="img-responsive" style="width:250px;height:250px;" />
					<h4>Developer</h4>
					<h4>Md Iqbal Hossain</h4>
					<br>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="#" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="images/f.jpg" alt=" " class="img-responsive" style="width:250px;height:250px;"/>
					<h4>Developer</h4>
					<h4>Foujul Ahsan Abir</h4>
					<br>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="#" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="images/irfan.jpg" alt=" " class="img-responsive" style="width:250px;height:250px;" />
					<h4>Spervised By</h4>
					<h4>Md Irfan Khan</h4>
					<br>
					<ul class="agileits_social_icons agileits_social_icons_team">
