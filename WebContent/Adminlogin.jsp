					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								...
								<li><a href="Ulogin.jsp">Sign Up</a></li>
									<li><a href="Aminlogin.jsp">Admin Login</a></li>
							</ul>
						</div>                  
					</div>	
				</li>
...
<!-- login -->
  ...
  </center><h2 style="color:red;margin-left:200px"><%if(name=="value"){ %>
			...
			<div class="w3_login_module">
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="Adminlogin_process" method="post">
