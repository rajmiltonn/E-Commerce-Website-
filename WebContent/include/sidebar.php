...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
								...
								<li><a href="insert-treatment.php"><i class="menu-icon icon-paste"></i>Insert Treatment </a></li>
                                <li><a href="manage-treatment.php"><i class="menu-icon icon-table"></i>Manage Treatment </a></li>
